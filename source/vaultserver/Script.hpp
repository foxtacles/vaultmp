...
class Script
{
	...
	public:
		...
		static void SetupObject(const FactoryObject& object, unsigned int cell, float X, float Y, float Z) noexcept;
		static void SetupItem(const FactoryItem& item, unsigned int cell, float X, float Y, float Z) noexcept;
		static void SetupContainer(const FactoryContainer& container, unsigned int cell, float X, float Y, float Z) noexcept;
		static void SetupActor(const FactoryActor& actor, unsigned int cell, float X, float Y, float Z) noexcept;
		static void SetupWindow(const FactoryWindow& window, float posX, float posY, float sizeX, float sizeY, bool visible, bool locked, const char* text) noexcept;
		static void SetupButton(const FactoryButton& button, float posX, float posY, float sizeX, float sizeY, bool visible, bool locked, const char* text) noexcept;
		static void SetupText(const FactoryText& text, float posX, float posY, float sizeX, float sizeY, bool visible, bool locked, const char* text_) noexcept;
		static void SetupEdit(const FactoryEdit& edit, float posX, float posY, float sizeX, float sizeY, bool visible, bool locked, const char* text) noexcept;
		static void SetupCheckbox(const FactoryCheckbox& checkbox, float posX, float posY, float sizeX, float sizeY, bool visible, bool locked, const char* text) noexcept;
		static void SetupRadioButton(const FactoryRadioButton& radiobutton, float posX, float posY, float sizeX, float sizeY, bool visible, bool locked, const char* text) noexcept;
		static void SetupList(const FactoryList& list, float posX, float posY, float sizeX, float sizeY, bool visible, bool locked, const char* text) noexcept;
