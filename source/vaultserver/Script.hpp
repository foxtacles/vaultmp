...
class Script
{
	...
	public:
		...
		static bool SetCell_(RakNet::NetworkID id, unsigned int cell, double X, double Y, double Z, bool nosend) noexcept;
		...
		static RakNet::NetworkID CreateItem(unsigned int baseID, RakNet::NetworkID id, unsigned int cell, double X, double Y, double Z) noexcept;
		...
		static RakNet::NetworkID CreateActor(unsigned int baseID, RakNet::NetworkID id, unsigned int cell, double X, double Y, double Z) noexcept;
